...
public class NewCalendarEventsTests extends AbstractTestBase {  //always extend this, because all logins all setup clean up coming from here
    //activities, calendar events, the verify owner name is current user name(you have to click on create calendar event first to see)
    ...
    public void defaultOptionsTest() {
        ...
        String expectedStartDate = DateTimeUtilities.getCurrentDate("MMM d, yyyy"); // if you put dd then goes 03 04 , 1 d means 1 2 3
